...
else
{
	...
	$view_type = (isset($ilance->GPC['view']) AND $ilance->GPC['view'] != '') ? handle_input_keywords($ilance->GPC['view']) : '';
	...
	$orderby_bids = $select_table . "." . $type_bids . " " . $order_type;
	...
	$SQL .= $groupby . "ORDER BY " . $ilance->db->escape_string($orderby_bids) . "";
